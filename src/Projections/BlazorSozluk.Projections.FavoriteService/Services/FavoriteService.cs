...
namespace BlazorSozluk.Projections.FavoriteService.Services
{
    public class FavoriteService
    {
        ...
        public async Task CreateEntryFav(CreateEntryFavEvent @event)  // event kelimesi C# dilinde ozel bir kelime oldugu icin basina @ isareti ekleyerek boyle bir degiskeni kullanabiliriz.
        {
            using var connection = new SqlConnection(connectionString);

            // Dapper ORM ile insert islemi yapiyoruz
